...
### b)
$R_eserie$ = 2 * $R_0$ = 2 * 6 $\Omega$ = 12 $\Omega$

$\frac {1} {R} = \frac {1} {R_eserie} + \frac {1} {R_{02}} => R_e = \frac {1} {\frac {1} {R_eserie} + \frac {1} {R_{02}}} = \frac {1} {\frac {1} {12 \Omega} + \frac {1} {6 \Omega}} = 4 \Omega $ 

### c)
$E_{total} = U_{total} + u_{total}$

$N * E = I * R_eserie + I * N * r = I * (R_eserie + N * r) $

=> $I = \frac {N * E} {R_eserie + N * r} = \frac {10 * 2.4 V} {12 \Omega + 10 * 0.4 \Omega} $ = 1.5 A
...
$U_{total} = I' * R = I_1 * R_eserie = I_2 * R_{02} $

$I_2 = I' - I_1$

$I_1 * R_eserie = (I' - I_1) * R_{02}$

$I_1 * R_eserie = I' * R_{02} - I_1 * R_{02}$

$I_1 * (R_eserie + R_{02}) = I' * R_{02} $

$I_1 = \frac {I' * R_{02}} {R_eserie + R_{02}} = \frac {3A * 6 \Omega} {12 \Omega + 6 \Omega} = 1A $
